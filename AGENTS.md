...
- **Grafos con panel de código** (`grafos/dfs.html`, `grafos/bfs.html`, `grafos/dijkstra.html`, `grafos/prim.html`): full-bleed con panel lateral, grafo animado en `<canvas>` (2/3) + pseudocódigo/explicación (1/3).
